var manual =
[
    [ "Changes: Objects, Scene & Nodes", "Ogre20Changes.html", [
      [ "Names are now optional", "Ogre20Changes.html#NamesAreNowOptional", null ],
      [ "How to debug MovableObjects' (and Nodes) data", "Ogre20Changes.html#HowToDebugMovableObjectsData", [
        [ "Interpreting ArrayVector3", "Ogre20Changes.html#InterpretingArrayVector3", null ],
        [ "Dummy pointers instead of NULL", "Ogre20Changes.html#DummyPointers", null ]
      ] ],
      [ "Attachment and Visibility", "Ogre20Changes.html#AttachmentAndVisibility", null ],
      [ "Attaching/Detaching is more expensive than hiding", "Ogre20Changes.html#AttachingDetachingIsMoreExpensive", null ],
      [ "All MovableObjects require a SceneNode (Lights & Cameras)", "Ogre20Changes.html#AllMovableObjectsRequireSceneNode", null ],
      [ "Obtaining derived transforms", "Ogre20Changes.html#DerivedTransforms", null ],
      [ "SCENE_STATIC and SCENE_DYNAMIC", "Ogre20Changes.html#SceneStaticSceneDynamic", [
        [ "What means a Node to be SCENE_STATIC", "Ogre20Changes.html#SceneStaticNode", null ],
        [ "What means a Entities (and InstancedEntities) to be SCENE_STATIC", "Ogre20Changes.html#SceneStaticEntities", null ],
        [ "General", "Ogre20Changes.html#SceneStaticGeneral", null ]
      ] ],
      [ "Ogre asserts mCachedAabbOutOfDate or mCachedTransformOutOfDate while in debug mode", "Ogre20Changes.html#AssersionCachedOutOfDate", null ],
      [ "Custom classes derived from Renderable or MovableObject", "Ogre20Changes.html#DerivingRenderable", null ],
      [ "How do I get the vertex information from the new v2 Mesh classes?", "Ogre20Changes.html#V2MeshInformation", null ],
      [ "How do I set the element offsets, vertex buffer's source and index?", "Ogre20Changes.html#V2MeshElementOffset", null ],
      [ "My scene looks too dark or dull!", "Ogre20Changes.html#SceneLooksDarkDull", null ],
      [ "I activated gamma correction, but now my GUI textures look washed out!", "Ogre20Changes.html#GUIWashedOut", null ]
    ] ],
    [ "Technical Overview", "TechnicalOverview.html", [
      [ "Overview", "TechnicalOverview.html#TechnicalOverviewOverview", [
        [ "SIMD Coherence", "TechnicalOverview.html#SIMDCoherence", null ]
      ] ],
      [ "Memory Managers usage patterns", "TechnicalOverview.html#MemoryManagerUsagePatterns", [
        [ "Cleanups", "TechnicalOverview.html#MemoryManagerCleanups", null ]
      ] ],
      [ "Memory preallocation", "TechnicalOverview.html#MemoryPreallocation", null ],
      [ "Configuring memory managers", "TechnicalOverview.html#ConfiguringMemoryManagers", null ],
      [ "Where is RenderTarget::update? Why do I get errors in Viewport?", "TechnicalOverview.html#RenderTargetUpdate", null ],
      [ "Porting from 1.x to 2.0", "TechnicalOverview.html#PortingV1ToV2", null ],
      [ "Porting from 2.0 to 2.1", "TechnicalOverview.html#PortingV20ToV21", null ]
    ] ],
