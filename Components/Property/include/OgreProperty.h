	...
	*/
	...
	public:
		...
		*/
		...
		template<> static PropertyType getTypeForValue(const short& val) { return PROP_SHORT; }
		template<> static PropertyType getTypeForValue(const unsigned short& val) { return PROP_UNSIGNED_SHORT; }
		template<> static PropertyType getTypeForValue(const int& val) { return PROP_INT; }
		template<> static PropertyType getTypeForValue(const unsigned int& val) { return PROP_UNSIGNED_INT; }
		template<> static PropertyType getTypeForValue(const long& val) { return PROP_LONG; }
		template<> static PropertyType getTypeForValue(const unsigned long& val) { return PROP_UNSIGNED_LONG; }
		template<> static PropertyType getTypeForValue(const Real& val) { return PROP_REAL; }
		template<> static PropertyType getTypeForValue(const String& val) { return PROP_STRING; }
		template<> static PropertyType getTypeForValue(const Vector2& val) { return PROP_VECTOR2; }
		template<> static PropertyType getTypeForValue(const Vector3& val) { return PROP_VECTOR3; }
		template<> static PropertyType getTypeForValue(const Vector4& val) { return PROP_VECTOR4; }
		template<> static PropertyType getTypeForValue(const ColourValue& val) { return PROP_COLOUR; }
		template<> static PropertyType getTypeForValue(const bool& val) { return PROP_BOOL; }
		template<> static PropertyType getTypeForValue(const Quaternion& val) { return PROP_QUATERNION; }
		template<> static PropertyType getTypeForValue(const Matrix3& val) { return PROP_MATRIX3; }
		template<> static PropertyType getTypeForValue(const Matrix4& val) { return PROP_MATRIX4; }
