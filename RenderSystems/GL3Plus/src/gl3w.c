...
static void load_procs(GL3WGetProcAddressProc proc)
{
	...
	gl3wBindShadingRateImageNV = (PFNGLBINDSHADINGRATEIMAGENVPROC)proc("glBindShadingRateImageNV");
	...
	gl3wBufferAttachMemoryNV = (PFNGLBUFFERATTACHMEMORYNVPROC)proc("glBufferAttachMemoryNV");
	...
	gl3wDrawMeshTasksIndirectNV = (PFNGLDRAWMESHTASKSINDIRECTNVPROC)proc("glDrawMeshTasksIndirectNV");
	gl3wDrawMeshTasksNV = (PFNGLDRAWMESHTASKSNVPROC)proc("glDrawMeshTasksNV");
	...
	gl3wEGLImageTargetTexStorageEXT = (PFNGLEGLIMAGETARGETTEXSTORAGEEXTPROC)proc("glEGLImageTargetTexStorageEXT");
	gl3wEGLImageTargetTextureStorageEXT = (PFNGLEGLIMAGETARGETTEXTURESTORAGEEXTPROC)proc("glEGLImageTargetTextureStorageEXT");
	...
	gl3wFramebufferFetchBarrierEXT = (PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC)proc("glFramebufferFetchBarrierEXT");
	gl3wFramebufferParameteri = (PFNGLFRAMEBUFFERPARAMETERIPROC)proc("glFramebufferParameteri");
	gl3wFramebufferParameteriMESA = (PFNGLFRAMEBUFFERPARAMETERIMESAPROC)proc("glFramebufferParameteriMESA");
	...
	gl3wGetFramebufferParameterivMESA = (PFNGLGETFRAMEBUFFERPARAMETERIVMESAPROC)proc("glGetFramebufferParameterivMESA");
	...
	gl3wGetMemoryObjectDetachedResourcesuivNV = (PFNGLGETMEMORYOBJECTDETACHEDRESOURCESUIVNVPROC)proc("glGetMemoryObjectDetachedResourcesuivNV");
	...
	gl3wGetShadingRateImagePaletteNV = (PFNGLGETSHADINGRATEIMAGEPALETTENVPROC)proc("glGetShadingRateImagePaletteNV");
	gl3wGetShadingRateSampleLocationivNV = (PFNGLGETSHADINGRATESAMPLELOCATIONIVNVPROC)proc("glGetShadingRateSampleLocationivNV");
	...
	gl3wMaxShaderCompilerThreadsKHR = (PFNGLMAXSHADERCOMPILERTHREADSKHRPROC)proc("glMaxShaderCompilerThreadsKHR");
	...
	gl3wMultiDrawMeshTasksIndirectCountNV = (PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTNVPROC)proc("glMultiDrawMeshTasksIndirectCountNV");
	gl3wMultiDrawMeshTasksIndirectNV = (PFNGLMULTIDRAWMESHTASKSINDIRECTNVPROC)proc("glMultiDrawMeshTasksIndirectNV");
	...
	gl3wNamedBufferAttachMemoryNV = (PFNGLNAMEDBUFFERATTACHMEMORYNVPROC)proc("glNamedBufferAttachMemoryNV");
	...
	gl3wNamedRenderbufferStorageMultisampleAdvancedAMD = (PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC)proc("glNamedRenderbufferStorageMultisampleAdvancedAMD");
	...
	gl3wRenderbufferStorageMultisampleAdvancedAMD = (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC)proc("glRenderbufferStorageMultisampleAdvancedAMD");
	...
	gl3wResetMemoryObjectParameterNV = (PFNGLRESETMEMORYOBJECTPARAMETERNVPROC)proc("glResetMemoryObjectParameterNV");
	...
	gl3wScissorExclusiveArrayvNV = (PFNGLSCISSOREXCLUSIVEARRAYVNVPROC)proc("glScissorExclusiveArrayvNV");
	gl3wScissorExclusiveNV = (PFNGLSCISSOREXCLUSIVENVPROC)proc("glScissorExclusiveNV");
	...
	gl3wShadingRateImageBarrierNV = (PFNGLSHADINGRATEIMAGEBARRIERNVPROC)proc("glShadingRateImageBarrierNV");
	gl3wShadingRateImagePaletteNV = (PFNGLSHADINGRATEIMAGEPALETTENVPROC)proc("glShadingRateImagePaletteNV");
	gl3wShadingRateSampleOrderCustomNV = (PFNGLSHADINGRATESAMPLEORDERCUSTOMNVPROC)proc("glShadingRateSampleOrderCustomNV");
	gl3wShadingRateSampleOrderNV = (PFNGLSHADINGRATESAMPLEORDERNVPROC)proc("glShadingRateSampleOrderNV");
	...
	gl3wTexAttachMemoryNV = (PFNGLTEXATTACHMEMORYNVPROC)proc("glTexAttachMemoryNV");
	...
	gl3wTextureAttachMemoryNV = (PFNGLTEXTUREATTACHMEMORYNVPROC)proc("glTextureAttachMemoryNV");
