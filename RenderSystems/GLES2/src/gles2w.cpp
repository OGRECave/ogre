...
PFNGLDRAWARRAYSINSTANCEDAPPLEPROC gleswDrawArraysInstancedAPPLE;
PFNGLDRAWELEMENTSINSTANCEDAPPLEPROC gleswDrawElementsInstancedAPPLE;
PFNGLVERTEXATTRIBDIVISORAPPLEPROC gleswVertexAttribDivisorAPPLE;
...
static void load_procs(void)
{
	...
	gleswDrawArraysInstancedAPPLE = (PFNGLDRAWARRAYSINSTANCEDAPPLEPROC) get_proc("glDrawArraysInstancedAPPLE");
	gleswDrawElementsInstancedAPPLE = (PFNGLDRAWELEMENTSINSTANCEDAPPLEPROC) get_proc("glDrawElementsInstancedAPPLE");
	gleswVertexAttribDivisorAPPLE = (PFNGLVERTEXATTRIBDIVISORAPPLEPROC) get_proc("glVertexAttribDivisorAPPLE");
