...
void main()
{
	outPos		= vertex * worldViewProj;

#ifdef DEPTH_SHADOWCASTER
	//Linear depth
	psDepth	= (outPos.z - depthRange0.x + shadowConstantBias) * depthRange0.w;
