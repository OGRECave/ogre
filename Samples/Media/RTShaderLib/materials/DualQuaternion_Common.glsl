...
{
	mat2x4 dq0;
	dq0[0] = dualQuaternions[(int(blendIdx.x) * 2)];
	dq0[1] = dualQuaternions[(int(blendIdx.x) * 2) + 1];
	
	mat2x4 dq1;
	dq1[0] = dualQuaternions[(int(blendIdx.y) * 2)];
	dq1[1] = dualQuaternions[(int(blendIdx.y) * 2) + 1];
