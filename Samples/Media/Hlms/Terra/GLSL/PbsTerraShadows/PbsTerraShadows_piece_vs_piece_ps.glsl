...
@piece( custom_vs_posExecution )
    vec3 terraShadowData = textureLod( terrainShadows, worldPos.xz * pass.invTerraBounds.xz + pass.terraOrigin.xz, 0 ).xyz;
    float terraHeightWeight = worldPos.y * pass.invTerraBounds.y + pass.terraOrigin.y;
