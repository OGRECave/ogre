...
@piece( DeclDecalsSamplers )
	@property( hlms_decals_diffuse )Texture2DArray decalsDiffuseTex;@end
	@property( hlms_decals_normals )Texture2DArray<float2> decalsNormalsTex;@end
	...
	@property( hlms_decals_emissive && hlms_decals_diffuse != hlms_decals_emissive )
		Texture2DArray decalsEmissiveTex;
	@end
@end
@end
