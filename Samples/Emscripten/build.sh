...
INCLUDES="-I$OGRE_SDK/include/OGRE/RTShaderSystem -I$OGRE_SDK/include/OGRE/RenderSystems/GLES2 -I$OGRE_SDK/include/OGRE/Overlay -I$OGRE_SDK/include/OGRE"
LIBRARIES="-L$OGRE_SDK/lib/ -lz -lOgreMain -lOgreOverlay -lOgreRTShaderSystem -lOGRE/RenderSystem_GLES2"
