...
MACRO(_PCH_GET_COMPILE_FLAGS _out_compile_flags)
    ...
    IF(CMAKE_COMPILER_IS_GNUCXX)
        ...
        if (_visibility AND ${_targetType} STREQUAL SHARED_LIBRARY)
            LIST(APPEND ${_out_compile_flags} "-D${_PCH_current_target}_EXPORTS")
        endif()
    ELSE()
        ...
        foreach(src ${_sources})
          if("${src}" MATCHES "\\.c(pp|xx)?$")
            ...
            if(NOT oldProps AND NOT oldProps2)
              ...
              message(STATUS "Skip PCH, flags: ${oldProps} defines: ${oldProps2}, file: ${src}")
            endif()
          endif()
        endforeach()
