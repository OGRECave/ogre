...
if(OGRE_BUILD_DEPENDENCIES AND NOT EXISTS ${OGREDEPS_PATH})
    ...
    if(MSVC OR EMSCRIPTEN) # other platforms ship zlib
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} -E tar xf zlib-1.2.11.tar.gz WORKING_DIRECTORY ${OGRE_BINARY_DIR})
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} --build ${CMAKE_BINARY_DIR}/zlib-1.2.11 ${BUILD_COMMAND_OPTS})
    endif()
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -E tar xf ZZIPlib-master.tar.gz WORKING_DIRECTORY ${OGRE_BINARY_DIR})
    execute_process(COMMAND cmake
        -DCMAKE_INSTALL_PREFIX=${OGREDEPS_PATH}
        -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} --build ${CMAKE_BINARY_DIR}/ZZIPlib-master ${BUILD_COMMAND_OPTS})
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -E tar xf freetype-2.6.5.tar.gz WORKING_DIRECTORY ${OGRE_BINARY_DIR})
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} --build ${CMAKE_BINARY_DIR}/freetype-2.6.5/objs ${BUILD_COMMAND_OPTS})
    ...
    if(MSVC) # other platforms dont need this
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} -E tar xf SDL2-2.0.5.tar.gz WORKING_DIRECTORY ${OGRE_BINARY_DIR})
        execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${OGRE_BINARY_DIR}/SDL2-build)
        execute_process(COMMAND cmake
            -DCMAKE_INSTALL_PREFIX=${OGREDEPS_PATH}
            -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
            -DSDL_STATIC=FALSE
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} --build ${OGRE_BINARY_DIR}/SDL2-build ${BUILD_COMMAND_OPTS})
    endif()
endif()
