...
if(OGRE_BUILD_DEPENDENCIES AND NOT EXISTS ${OGREDEPS_PATH})
    ...
    if(MSVC OR MINGW OR SKBUILD) # other platforms dont need this
      ...
      file(DOWNLOAD
              https://github.com/assimp/assimp/archive/refs/tags/v6.0.4.tar.gz
          ${PROJECT_BINARY_DIR}/v6.0.4.tar.gz)
      execute_process(COMMAND ${CMAKE_COMMAND}
          -E tar xf v6.0.4.tar.gz WORKING_DIRECTORY ${PROJECT_BINARY_DIR})
      execute_process(COMMAND ${BUILD_COMMAND_COMMON}
          ...
          ${PROJECT_BINARY_DIR}/assimp-6.0.4
          WORKING_DIRECTORY ${PROJECT_BINARY_DIR}/assimp-6.0.4)
      execute_process(COMMAND ${CMAKE_COMMAND}
        --build ${PROJECT_BINARY_DIR}/assimp-6.0.4 ${BUILD_COMMAND_OPTS})
    endif()
