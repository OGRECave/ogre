...
xcodebuild -project OGRE.xcodeproj -target doc -configuration Release -sdk macosx10.6 ARCHS=i386 DEFAULT_COMPILER=com.apple.compilers.llvmgcc42 MACOSX_DEPLOYMENT_TARGET=10.5
...
# Invoke Xcode build
xcodebuild -project OGRE.xcodeproj -target install -parallelizeTargets -configuration Release -sdk macosx10.6 ARCHS="i386 x86_64" DEFAULT_COMPILER=com.apple.compilers.llvmgcc42 MACOSX_DEPLOYMENT_TARGET=10.5
